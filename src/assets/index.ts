...
import ledgerNanoSPlus from './select_device/ledger_nano_s_plus.webp'
import ledgerNanoX from './select_device/ledger_nano_x.webp'
...
export const getting_started_video = gettingStartedVideo
export const ledger_flex = ledgerFlex
export const ledger_stax = ledgerStax
export const ledger_nano_s = ledgerNanoSPlus
